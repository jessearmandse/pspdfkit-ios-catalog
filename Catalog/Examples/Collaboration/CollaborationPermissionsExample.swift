...
private class CollaborationPermissionInstantDocumentViewController: InstantDocumentViewController {
    ...
    /// Requires a tap and hold on iOS 13 for activiation.
    lazy var groupModeButton: UIBarButtonItem = {
        let menu = UIMenu(children: self.changeGroupActions())
        return UIBarButtonItem.contextMenuBarButtonItem(image: publicModeImage, menu: menu)
    }()
    ...
    /// Internally it changes teh default group for the newly created annotations and comments
...
/// To learn more about how to set the permissions, please see: https://pspdfkit.com/guides/web/collaboration-permissions/defining-permissions/
...
/// https://pspdfkit.com/guides/web/collaboration-permissions/defining-permissions/
