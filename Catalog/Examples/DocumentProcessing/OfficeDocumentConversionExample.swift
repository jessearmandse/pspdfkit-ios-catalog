...
class OfficeDocumentConversionExample: Example {
    ...
    override init() {
        ...
        contentDescription = "Shows how to convert an Office file to PDF using PSPDFKit Server."
...
private class OfficeDocumentPickerTableViewController: UITableViewController {
    ...
    private lazy var sections: [Section] = {
        ...
        /// https://pspdfkit.com/guides/server/pspdfkit-server/client-authentication/#special-notes-for-mobile-document-conversion
        ///
        ...
        /// a different public/private key pair for PSPDFKit server, these JWTs will need to be re-generated. Also note that
        ...
        let documents = [
            OfficeDocument(fileName: "PSPDFKit_DocSupport", fileExtension: "docx", jwt: "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjk5OTk5OTk5OTksInNoYTI1NiI6IjU3OWVhY2IxMzZmYzE0NTg0MDZhOTNjMzQxOWY3ZTkxZTYxNWMzZDFkYTM1YTc4MTkxNzg5ZWE5YWE4YzJhOGMifQ.ENAT4TwjTk9dBNGb_dVd_Nzk2TqpRFLEQVJui_7702PPbnVYBXgQ_RYfbckS6_5iJofENxxIOGUboxqLQGLKtA", displayName: "Word document (.docx)"),
            OfficeDocument(fileName: "PSPDFKit_ExcelSupport", fileExtension: "xlsx", jwt: "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjk5OTk5OTk5OTksInNoYTI1NiI6IjFlMzVmMjlhOGQyM2E5NjdhZGIzZjhmNjg0NWY2MGQwYjI3OWI1NmJmMTAxN2M5ODI0ZmJiM2EwMmE2NmUwNTIifQ.DmdimV2ZCbKC6B0OfzhsLGHteBKXajokgl0hMN4b0_BFAVyNBqCp556lcWnKxnYMWJfziIyODT4RDMdoQfnZaA", displayName: "Excel document (.xlsx)"),
            OfficeDocument(fileName: "PSPDFKit_PresentationSupport", fileExtension: "pptx", jwt: "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjk5OTk5OTk5OTksInNoYTI1NiI6ImVmYmUyNWVjNzUyMTE0NzkxMjMyMTFhZDFjY2E1YjZiN2U5MTlmMmIxNmQxYzgxNTBkMzIyYmI1Yjc3N2MyM2QifQ.BOMUjkrF1jgu5tKBqn-xhHXvGS6u4kxr_MTFI8TZwsGROy1nP0a95TDESWPf0JDhhl80U1KUUuZUw4n-xsUahA", displayName: "Powerpoint document (.pptx)")
        ]

        return [
            Section(header: "Office file conversion powered by PSPDFKit Server", rows: [], footer: "NOTE: This example needs a local instance of PSPDFKit Server which supports running Office file conversion. Steps to setup the local server can be found at: https://pspdfkit.com/guides/ios/features/office-conversion/. If using a non-local PSPDFKit Server, change the server URL appropriately."),
    ...
    private func convertAndPresentDocument(withIdentifier identifier: OfficeDocument) {
        /// NOTE: This example needs a local instance of PSPDFKit server which supports running Office file conversion.
        ///
        /// Steps to setup the local server can be found at: https://pspdfkit.com/guides/ios/features/office-conversion/
        ///
        /// If using a non-local PSPDFKit server, change the server URL appropriately.
