...
class SwiftUICustomInspectorExample: Example {
    ...
    override init() {
        ...
        // This example uses @StateObject; with care it could be made compatible with iOS 13.
...
@available(iOS 14.0, *)
private class CustomInspectorPresentationManager: ObservableObject {
...
private struct CustomInspectorView: View {
    ...
    private func changeAnnotationsColor(to color: UIColor) {
        annotations.forEach { annotation in
            ...
            // https://pspdfkit.com/guides/ios/annotations/the-annotation-object-model/
