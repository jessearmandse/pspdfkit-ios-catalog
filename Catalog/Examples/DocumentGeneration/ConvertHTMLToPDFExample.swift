...
class ConvertHTMLToPDFExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        ...
        // Uncomment amd comment the below lines to see it in action.
        // Processor.generatePDF(from: URL(string: "https://pspdfkit.com")!, outputFileURL: outputURL, options: options) { actualOutputURL, error in
